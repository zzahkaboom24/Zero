...
export const mail0UserHotkeys = pgTable(
  'mail0_user_hotkeys',
  {
...
export const mail0UserSettings = pgTable(
  'mail0_user_settings',
  {
    id: text().primaryKey().notNull(),
...
export const mail0WritingStyleMatrix = pgTable(
  'mail0_writing_style_matrix',
  {
...
export const mail0OrganizationDomain = pgTable(
  'mail0_organization_domain',
  {
    id: text().primaryKey().notNull(),
...
export const mail0Invitation = pgTable(
  'mail0_invitation',
  {
    id: text().primaryKey().notNull(),
    email: text().notNull(),
...
export const mail0Organization = pgTable(
  'mail0_organization',
  {
    id: text().primaryKey().notNull(),
    name: text().notNull(),
  ...
  (table) => [unique('mail0_organization_slug_unique').on(table.slug)],
);

export const mail0Member = pgTable(
  'mail0_member',
  {
    id: text().primaryKey().notNull(),
    userId: text().notNull(),
...
export const mail0Account = pgTable(
  'mail0_account',
  {
    id: text().primaryKey().notNull(),
...
export const mail0Connection = pgTable(
  'mail0_connection',
  {
    id: text().primaryKey().notNull(),
    userId: text('user_id').notNull(),
...
export const mail0EarlyAccess = pgTable(
  'mail0_early_access',
  {
    id: text().primaryKey().notNull(),
    email: text().notNull(),
    ...
    hasUsedTicket: text('has_used_ticket').default('false').notNull(),
  },
  (table) => [unique('mail0_early_access_email_unique').on(table.email)],
);
...
export const mail0OauthAccessToken = pgTable(
  'mail0_oauth_access_token',
  {
    id: text().primaryKey().notNull(),
    accessToken: text('access_token'),
    refreshToken: text('refresh_token'),
...
export const mail0OauthApplication = pgTable(
  'mail0_oauth_application',
  {
    id: text().primaryKey().notNull(),
    name: text(),
    icon: text(),
  ...
  (table) => [unique('mail0_oauth_application_client_id_unique').on(table.clientId)],
);
...
export const mail0Session = pgTable(
  'mail0_session',
  {
    id: text().primaryKey().notNull(),
    expiresAt: timestamp('expires_at', { mode: 'string' }).notNull(),
...
export const mail0Note = pgTable(
  'mail0_note',
  {
    id: text().primaryKey().notNull(),
    userId: text('user_id').notNull(),
...
export const mail0User = pgTable(
  'mail0_user',
  {
    id: text().primaryKey().notNull(),
    name: text().notNull(),
