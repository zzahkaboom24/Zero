...
CREATE TABLE "mail0_organization_connection" (
...
ALTER TABLE "mail0_organization_connection" ADD CONSTRAINT "mail0_organization_connection_organizationId_mail0_organization_id_fk" FOREIGN KEY ("organizationId") REFERENCES "public"."mail0_organization"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mail0_organization_connection" ADD CONSTRAINT "mail0_organization_connection_connectionId_mail0_connection_id_fk" FOREIGN KEY ("connectionId") REFERENCES "public"."mail0_connection"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "writing_style_matrix_style_idx" ON "mail0_writing_style_matrix" USING btree ("style");--> statement-breakpoint
ALTER TABLE "mail0_member" ADD CONSTRAINT "mail0_member_userId_organizationId_unique" UNIQUE("userId","organizationId");